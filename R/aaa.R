...
utils::globalVariables("boxplot_stats")
...
utils::globalVariables("density_scaled")
...
utils::globalVariables("violinwidth")
...
utils::globalVariables("start_point")
utils::globalVariables("speed_factor")
