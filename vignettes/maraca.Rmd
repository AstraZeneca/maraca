...
Finally, the `ordered` and `original` columns must contain numerical values
for the ordered and original data respectively.
...
The following types of plots that are available: "default", "violin", "box", "scatter". The default type is just a nested combination of violin and box plot.
...
`plot_tte_composite` plots the Kaplan-Meier plot for the composite of all events.
