...
These examples show how to modify those parameters.
...
```{r out.width=600, out.height=400, message=FALSE}
animate_plot(mar,
             anim_width = 600,
             anim_height = 400,
             continuous_grid_spacing_x = 20)
...
For instance, we can animate a figure with a scatter instead of a violin plot. 
...
Also binary endpoints (either for the final or any step outcomes) can be
animated.
```{r}
data("hce_scenario_a")
